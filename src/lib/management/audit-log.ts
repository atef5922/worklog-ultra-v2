export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  "attendance.day_override_updated": "Attendance day setting updated",
  "attendance.report_exported": "Attendance report exported",
...
export function auditActionSummary(action: string, targetName: string) {
  const summaries: Record<string, string> = {
    ...
    "attendance.day_override_updated": `An authorized reviewer changed a dated attendance setting for ${targetName}.`,
    "attendance.report_exported": "An authorized manager exported scoped attendance records.",
