...
-- CreateEnum
CREATE TYPE "AttendanceStatus" AS ENUM ('present', 'late', 'half_day', 'absent', 'remote');

-- CreateEnum
CREATE TYPE "ReminderKind" AS ENUM ('attendance_morning', 'plan_morning', 'report_evening');
...
CREATE TABLE "users" (
    ...
    "extra_access" TEXT[] DEFAULT ARRAY[]::TEXT[],
...
-- CreateIndex
CREATE INDEX "report_edit_requests_daily_task_id_created_at_idx" ON "report_edit_requests"("daily_task_id", "created_at");

-- CreateIndex
CREATE INDEX "report_edit_requests_requested_by_id_created_at_idx" ON "report_edit_requests"("requested_by_id", "created_at");

-- CreateIndex
CREATE INDEX "report_edit_requests_status_created_at_idx" ON "report_edit_requests"("status", "created_at");
...
-- CreateIndex
CREATE INDEX "workspace_messages_recipient_id_created_at_idx" ON "workspace_messages"("recipient_id", "created_at");

-- CreateIndex
CREATE INDEX "workspace_messages_sender_id_created_at_idx" ON "workspace_messages"("sender_id", "created_at");

-- CreateIndex
CREATE INDEX "workspace_message_attachments_message_id_created_at_idx" ON "workspace_message_attachments"("message_id", "created_at");

-- CreateIndex
CREATE INDEX "reminder_dispatches_reminder_date_kind_idx" ON "reminder_dispatches"("reminder_date", "kind");

-- CreateIndex
CREATE UNIQUE INDEX "reminder_dispatches_user_id_reminder_date_kind_key" ON "reminder_dispatches"("user_id", "reminder_date", "kind");
...
-- AddForeignKey
ALTER TABLE "report_edit_requests" ADD CONSTRAINT "report_edit_requests_daily_task_id_fkey" FOREIGN KEY ("daily_task_id") REFERENCES "daily_tasks"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "report_edit_requests" ADD CONSTRAINT "report_edit_requests_requested_by_id_fkey" FOREIGN KEY ("requested_by_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "report_edit_requests" ADD CONSTRAINT "report_edit_requests_reviewer_id_fkey" FOREIGN KEY ("reviewer_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "workspace_messages" ADD CONSTRAINT "workspace_messages_recipient_id_fkey" FOREIGN KEY ("recipient_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "workspace_message_attachments" ADD CONSTRAINT "workspace_message_attachments_message_id_fkey" FOREIGN KEY ("message_id") REFERENCES "workspace_messages"("id") ON DELETE CASCADE ON UPDATE CASCADE;
